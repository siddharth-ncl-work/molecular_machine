...
def getNetRotation(file,start_frame_no,end_frame_no,step_size,part1='ring',part2='track',type='abs',method='atomic_r_t',part1_atom_list=[],part2_atom_list=[]):
...
def rot_atomic_r_t(frame1_cords,frame2_cords,part='ring',atom_list=[]):
  ...
  avg_rotation=net_rotation/len(atom_list)
  return avg_rotation

def atomic_t_r(frame1_cords,frame2_cords,part='ring',method='r+t',atom_list=[]):
  pass
  #translate cords of prev_frame
  #getRPYAngles with new prev_frame_cords
